// NOTE: https://gobyexample.com/timeouts
/*
  Timeous are important for programs that connect to external resources or that otherwise
...
func main() {
	...
	/*
	   For our example, suppose we are executing anm external call that returns after 2s.
	...
	*/
	...
	/*
	   ...
	   res := <- c1 awaits the result and <- Time.After awaits a value to be  sent after the timeout
	   of 1s.
